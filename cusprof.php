...
$host = "localhost";
        ...
        $bp= "SELECT * FROM sighups WHERE email = '$email'"  ;
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="nav-item"><a class="nav-link" href="cusprof.php">User</a></li>
                    ...
                    <li class="nav-item">
                        <h4 style="padding-top:4px;padding-left:4px;"><?php echo $usemail ;    ?></h4>
                    </li>
                    <li class="nav-item">
...
<section style="padding:60px;text-align:center; padding-top: 100px;">
            ...
            <div class="section group"style="padding-left: 240px;"> 
                <table class="tblone" style=" width:700px;border:5px solid coral;">
                    <tr style="padding:5px;">
                        <td >Customer Id</td>
                        <td>:</td>
                        <td><?php echo $rows[0];?></td>
                    </tr>
                    <tr style="background-color: #CCE5FF;padding:5px;">
                        <td>First Name</td>
                        <td>:</td>
