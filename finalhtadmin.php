...
$host = "localhost";
        ...
        $cu= "SELECT * FROM adminsignup WHERE email = '$email'"  ;
                            $res=mysqli_query($conn,$cu);
                            $row=mysqli_fetch_array($res);
                            $ademail=$row[3];
                            $_SESSION['uname']=$ademail;
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <section id="new1" class="w-100">
        ...
        <div class="row p-5 m-5">
            <div style="text-align:center;font-size:55px;" class="one">
                <a href="cat_car_la.php"><img class="imgs" src="car11.jpg"></a>
                <h3>𝔠𝔞𝔯𝔰</h3>
            </div>
            <div style="text-align:center;font-size:55px;" class="one">
                <a href="cat_laptops_la.php"><img class="imgs" src="laptop2.jpg"></a>
                <h3>𝖑𝖆𝖕𝖙𝖔𝖕</h3>
            </div>
            <div style="text-align:center;font-size:55px;" class="one">
                <a href="cat_watches_la.php"><img class="imgs" src="cat3.jpg"></a>
                <h3>𝖜𝖆𝖙𝖈𝖍</h3>
            </div>
            <div style="text-align:center;font-size:55px;" class="one">
