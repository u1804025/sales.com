...
$ademail=$_SESSION['uname'];
    ...
    $sql='SELECT * FROM productnew WHERE productcategory = "Mobilephone"' ;
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light p-4 fixed-top">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <h2  style="font-size:30px;">Mobilephone</h2>
        ...
        ?>
            ...
            <br>
                        ...
                        <a href="buynowa.html"><button class="prod-btn"style="border:0px solid;background-color:tomato;color:black;" class="my-3 py-3">Bid now </button></a>
