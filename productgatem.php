...
<body>
    ...
    <div  style="padding-left: 100px;">
            ...
            <tr  style="border: 1px solid black; height:30px">
                ...
                <td style="border: 1px solid black;"> Buys at price</td>
            </tr>
            <?php
            $sql="SELECT * FROM soldp WHERE bidderemail='$email'" ;
        ...
        <tr  style="border: 1px solid black; height:30px">
            ...
            <td style="border: 1px solid black;"> Buyer Email</td>
            <td style="border: 1px solid black;"> Sold at price</td>
        </tr>
        <?php
        $sqls="SELECT * FROM soldp WHERE uploaderemail='$email'" ;
        $results=mysqli_query($conn,$sqls);
        $carss=mysqli_fetch_all($results,MYSQLI_ASSOC);
        ?>
        <?php foreach($carss as $cars){?> 
        <tr style="border: 1px solid black; height:30px">
            <td style="border: 1px solid black;">
                <?php
                echo htmlspecialchars($cars['productid']);
                ?>
            </td>
            
            <td style="border: 1px solid black;">
                <?php
                echo htmlspecialchars($cars['bidderemail']);
                ?>
            </td>
            <td style="border: 1px solid black;">
                <?php
                echo htmlspecialchars($cars['currentprice']);
                ?>
            </td>
        </tr>
        <?php }?>
